...
// serviceAccountToken: 지정한 namespace의 해당 service account token을 반환하며,
...
// tokenRequest: Kubernetes TokenRequest API 응답을 간략히 표현한 구조체로,
...
//
// 실제 API 응답에는 metadata, spec, status.expirationTimestamp 등이 더 들어 있지만,
// 필요한 status.token 하나만 정의했다.
