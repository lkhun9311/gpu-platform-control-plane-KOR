...
// IsCertManagerCRDsInstalled: Cert Manager 관련 핵심 CRD의 존재 여부를 확인해,
...
// GetNonEmptyLines: 주어진 명령 출력 문자열을 줄바꿈 기준으로 개별 항목으로 나누고,
// 그중 빈 요소는 무시한다.
//
// Go 문법 설명:
...
// UncommentCode: 파일에서 target을 찾아 해당 내용의 주석 접두사를 제거하며,
