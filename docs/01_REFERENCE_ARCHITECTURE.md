...
> uses to tell reserved GPU-seconds from observed ones, and it has been pointed at real cards: the paid
> queuelab sessions carry device scrapes and records naming `dcgm-exporter` as the observer. Every
> GPU in the kind clusters is simulated by a fake device plugin. The GPUs in the paid EC2 sessions — more
> than thirty of them since 2026-09-02 — were real.
